...
pbjs -p shared -p control -p request -p stream -t static-module -o build/index.js --wrap es6 shared/*.proto control/*.proto request/*.proto stream/*.proto
pbts -o build/index.d.ts build/index.js
printf "...done\n"
